...
<head>
    ...
    <title>Coverage for /usr/local/lib/python3.9/site-packages/rest_framework/utils/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/usr/local/lib/python3.9/site-packages/rest_framework/utils/__init__.py</b> :
